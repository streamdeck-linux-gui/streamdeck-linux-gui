...
################################################################################
## Form generated from reading UI file 'old_button.ui'
##
...
class Ui_ButtonForm(object):
    def setupUi(self, ButtonForm):
        ...
        self.pluingForm = QWidget(ButtonForm)
        self.pluingForm.setObjectName("uPluginForm")

        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.pluingForm)
